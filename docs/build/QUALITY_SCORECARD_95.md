...
| BUILD-4 | 95 | 110 testes de domínio/aplicação/API/UI, transições/idempotência e guardas de policy | PASS local |
...
| BUILD-6 | 95 | 27/27 Playwright desktop/tablet/mobile, incluindo request contextual, resultado/paciente, layout da solicitação e landing técnica do ADMIN | PASS local |
...
| BUILD-10 | 96 | 110 testes, 95.35% statements, 81.05% branches, lint/typecheck/build/audit/secret scan | PASS local |
