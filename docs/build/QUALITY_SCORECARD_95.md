...
| BUILD-2 | 96 | envelope/correlation, body limit, métricas protegidas e OpenAPI 49 paths validada | PASS local |
| BUILD-3 | 96 | migration runner incremental, migration 002, PostgreSQL smoke, audit/outbox projection | PASS local |
| BUILD-4 | 95 | 119 testes de domínio/aplicação/API/UI, transições/idempotência e guardas de policy | PASS local |
...
| BUILD-6 | 95 | 33/33 Playwright desktop/tablet/mobile, incluindo request contextual, gestão de catálogo/acesso, escopo delegado, resultado/paciente, layout da solicitação e landing técnica do ADMIN | PASS local |
...
| BUILD-10 | 96 | 119 testes, 94.97% statements, 80.74% branches, lint/typecheck/build/audit/secret scan | PASS local |
